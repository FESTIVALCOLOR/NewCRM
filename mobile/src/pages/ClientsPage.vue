...
.crm-filter-select :deep(.q-field__control) { border-radius: 8px !important; height: 32px !important; min-height: 32px !important; overflow: hidden !important; }
.crm-filter-select :deep(.q-field--dense .q-field__control) { height: 32px !important; min-height: 32px !important; }
.crm-filter-select :deep(.q-field__native) { padding-top: 0 !important; padding-bottom: 0 !important; min-height: 30px !important; overflow: hidden !important; white-space: nowrap !important; text-overflow: ellipsis !important; }
