<template>
  <q-page padding>
    ...
    <div class="row q-col-gutter-xs q-mb-md">
      ...
      <div class="col-auto"><q-btn outlined no-caps label="Сбросить" color="grey-7" @click="resetFilters" :style="{ fontSize: '12px', height: '40px', minHeight: '40px', border: '1px solid #bdbdbd', borderRadius: '4px', minWidth: '90px', padding: '0 12px' }" /></div>
    </div>
