    ...
    <template v-else-if="card">
      ...
      <q-card class="is-card q-mb-md" style="position: relative">
        ...
        <q-btn
          ...
          dense
          icon="arrow_back"
          style="position: absolute; top: -14px; left: -14px; z-index: 10; width: 32px; height: 32px; min-height: 32px; background: white; border: 1.5px solid #E0E0E0; box-shadow: 0 2px 8px rgba(0,0,0,0.13); color: #555"
          @click="$router.back()"
        >
