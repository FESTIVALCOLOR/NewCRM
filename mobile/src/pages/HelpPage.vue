          ...
          <q-card-section class="q-pa-md">
            ...
            <div class="role-block">
              ...
              <div class="role-tree">
                ...
                <div class="rt-step" style="margin-left:16px">
                  2. Откройте карточку → вкладка <b>Данные</b> → блок вашей стадии:
                </div>
                <div class="rt-branch" style="margin-left:16px">
                  <div class="rt-leaf">
                    • Красная кнопка <b>«Правки»</b> — нажмите, чтобы открыть файл с пометками СДП
                    (откроется папка «Правки» на Яндекс.Диске)
                  </div>
                  <div class="rt-leaf">
                    • Изучите файл — там конкретные пометки что именно нужно исправить
                  </div>
                </div>
                <div class="rt-step" style="margin-left:16px">
                  3. Внесите правки → кнопка <b>«Загрузить»</b> → загрузите исправленные файлы в тот же блок
                </div>
                <div class="rt-step" style="margin-left:16px">
                  4. Снова нажмите <b>«Сдать работу»</b>
                </div>
                <div class="rt-branch" style="margin-left:16px">
                  <div class="rt-leaf">
          ...
          <q-card-section class="q-pa-md">
            ...
            <div class="role-block">
              ...
              <div class="role-tree">
                ...
                <div class="rt-branch">
                  <div class="rt-leaf">
                    • Уведомление с причиной от СДП/ГАП — прочитайте внимательно
                  </div>
                  <div class="rt-leaf">
                    • Вкладка <b>Данные</b> → блок вашей стадии → красная кнопка <b>«Правки»</b>
                    → откроется папка с файлом правок на Яндекс.Диске
                  </div>
                  <div class="rt-leaf">
                    • Изучите файл с пометками → внесите изменения в чертежи
                  </div>
                  <div class="rt-leaf">
                    • Кнопка <b>«Загрузить»</b> → загрузить исправленные файлы → кнопка <b>«Сдать работу»</b>
                  </div>
                </div>
              </div>
            </div>
          ...
          <q-card-section class="q-pa-md">
            ...
            <div class="role-block">
              ...
              <div class="role-tree">
                ...
                <div class="rt-branch">
                  <div class="rt-leaf rt-warn">
                    ✗ ОТКЛОНИТЬ → кнопка <b>«Отклонить»</b> → откроется диалог «На исправление»
                  </div>
                </div>
                ...
                <div class="rt-step" style="margin-left:12px">
                  2. Кнопка <b>«Прикрепить файл с правками»</b> (необязательно, но рекомендуется):
                </div>
                <div class="rt-branch" style="margin-left:24px">
                  <div class="rt-leaf">
                    • Загрузить PDF, фото или видео с разметкой / пометками
                  </div>
                  <div class="rt-leaf">
                    • Файл автоматически сохранится в папку <b>«Правки»</b> нужной стадии на ЯД
                  </div>
                  <div class="rt-leaf">
                    • Для Стадии 2 папка создаётся автоматически в подпапке подэтапа
                    (Концепция-коллажи / Правки или 3D визуализация / Правки)
                  </div>
                  <div class="rt-leaf">
                    • Исполнитель увидит красную кнопку <q-icon name="rate_review" size="12px" /> <b>«Правки»</b> прямо в блоке своей стадии
                  </div>
                </div>
                <div class="rt-step" style="margin-left:12px">
                  3. <b>«Отправить»</b> → дизайнер/чертёжник получит уведомление с причиной
                </div>
              </div>
            </div>
