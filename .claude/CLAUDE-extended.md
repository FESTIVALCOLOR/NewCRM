...
| 2 | Design | .claude/agents/design-agent.md | sonnet | C4, DFD, ADR, тест-стратегия |
| 3 | Planner | .claude/agents/planner-agent.md | sonnet | Планирование задач, roadmap.md |
| 4 | Worker | .claude/agents/worker-agent.md | sonnet | Исполнение кода, координация |
...
| 11 | Senior Reviewer | .claude/agents/senior-reviewer-agent.md | sonnet | Архитектурный обзор |
...
| 17 | Deploy | .claude/agents/deploy-agent.md | sonnet | Docker деплой + мониторинг |
