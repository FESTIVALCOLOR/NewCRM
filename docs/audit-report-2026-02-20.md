...
| Критерий | До аудита | Phase 0+1 | Phase 2+3 | Phase 4 | Phase 5 | Phase 6-6.3 | Целевое |
|----------|-----------|-----------|-----------|---------|---------|-------------|---------|
| Тесты pass rate | 93.8% | 99.8% | 99.3% | 99.3% (553/557) | 99.4% (782/786) | **99.4%** (507 core) | >99% ✅ |
| Тесты skipped | 79 | 79 | 79 | 79 | 81 | **81** | <5 |
...
| crm_tab.py строк | 18 228 | 18 228 | 18 228 | 3 368 (−81%) | 3 368 | **3 368** | <5 000 ✅ |
| supervision_tab.py строк | 8 411 | 8 411 | 8 411 | 2 246 (−71%) | 2 246 | **2 246** | <5 000 ✅ |
| contracts_tab.py строк | 5 030 | 5 030 | 5 030 | 5 030 | 693 (−86%) | **693** | <2 000 ✅ |
| db_manager.py строк | 6 675 | 6 675 | 6 675 | 5 203 (−22%) | 5 203 | **5 203** | <5 000 |
| Макс. размер файла | 18 228 | 18 228 | 18 228 | 8 201 | 5 203 | **5 203** | <3 000 |
| DataAccess методов | ~90 | ~90 | ~101 | 177+ | 201+ | **201+** (34 write + 90 read) | — |
| DataAccess adoption в UI | 3% | 3% | 3% | 97.2% | 100% | **100%** | 100% ✅ |
| Прямых вызовов api/db в UI | 759 | 759 | 759 | 21 | 0 | **0** | 0 ✅ |
| Offline write-методов | 0 | 0 | 0 | 0 | 24 | **34** (все write-методы) | 34 ✅ |
...
> Составлен 2026-02-21 по результатам фаз 0-6.3. Консолидация из audit-report + 01-roadmap + 22-optimization-roadmap.
...
| Приоритет | Кол-во | Высокая сложность |
|-----------|--------|-------------------|
| 1 (Безопасность) | 6 | 1 |
| 2 (Архитектура) | 8 | 4 |
| 3 (Тесты) | 4 | 2 |
| 4 (UX) | 6 | 2 |
| 5 (Инфраструктура) | 12 | 3 |
| **Итого** | **36** | **12** |
