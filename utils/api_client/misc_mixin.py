...
class MiscMixin:
    ...
    def get_notification_settings(self, employee_id: int) -> Optional[Dict[str, Any]]:
    ...
    def update_notification_settings(self, employee_id: int, data: Dict[str, Any]) -> Optional[Dict[str, Any]]:
